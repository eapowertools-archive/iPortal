...
Click [here](https://github.com/eapowertools/iPortal/releases/download/1.0.3/iPortal_Setup.exe) to download the most recent installation package.  The fully automated installer will:  
